 ...
 * ### Syntax
 *
 * - `<div [pydtBusy]="busy">...</div>`
 * - `<div [pydtBusy]="[busyA, busyB, busyC]">...</div>`
 * - `<div [pydtBusy]="{busy: busy, message: 'Loading...', backdrop: false, delay: 200, minDuration: 600}">...</div>`
 */
@Directive({
    selector: '[pydtBusy]',
