...
export const CIV6_LEADERS = [
    RANDOM_CIV,
    new CivDef('CIVILIZATION_MACEDON', 'LEADER_ALEXANDER', { dlcId: 'E2749E9A-8056-45CD-901B-C368C8E83DEB' }),
    new CivDef('CIVILIZATION_NUBIA', 'LEADER_AMANITORE', { dlcId: '643EA320-8E1A-4CF1-A01C-00D88DDD131A' }),
    new CivDef('CIVILIZATION_FRANCE', 'LEADER_CATHERINE_DE_MEDICI'),
    new CivDef('CIVILIZATION_INDIA', 'LEADER_CHANDRAGUPTA', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
    new CivDef('CIVILIZATION_EGYPT', 'LEADER_CLEOPATRA'),
    new CivDef('CIVILIZATION_PERSIA', 'LEADER_CYRUS', { dlcId: 'E2749E9A-8056-45CD-901B-C368C8E83DEB' }),
    new CivDef('CIVILIZATION_GERMANY', 'LEADER_BARBAROSSA', { leaderDisplayName: 'Frederick Barbarossa' }),
    new CivDef('CIVILIZATION_INDIA', 'LEADER_GANDHI'),
    new CivDef('CIVILIZATION_MONGOLIA', 'LEADER_GENGHIS_KHAN', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
    new CivDef('CIVILIZATION_SUMERIA', 'LEADER_GILGAMESH'),
    new CivDef('CIVILIZATION_INDONESIA', 'LEADER_GITARJA', { dlcId: '1F367231-A040-4793-BDBB-088816853683' }),
    new CivDef('CIVILIZATION_GREECE', 'LEADER_GORGO'),
    new CivDef('CIVILIZATION_NORWAY', 'LEADER_HARDRADA', { leaderDisplayName: 'Harald Hardrada' }),
    new CivDef('CIVILIZATION_JAPAN', 'LEADER_HOJO', { leaderDisplayName: 'Hojo Tokimune' }),
    new CivDef('CIVILIZATION_POLAND', 'LEADER_JADWIGA', { dlcId: '3809975F-263F-40A2-A747-8BFB171D821A' }),
    new CivDef('CIVILIZATION_KHMER', 'LEADER_JAYAVARMAN', { dlcId: '1F367231-A040-4793-BDBB-088816853683' }),
    new CivDef('CIVILIZATION_AUSTRALIA', 'LEADER_JOHN_CURTIN', { dlcId: 'E3F53C61-371C-440B-96CE-077D318B36C0' }),
    new CivDef('CIVILIZATION_MAPUCHE', 'LEADER_LAUTARO', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
    new CivDef('CIVILIZATION_AZTEC', 'LEADER_MONTEZUMA', { dlcId: '02A8BDDE-67EA-4D38-9540-26E685E3156E' }),
    new CivDef('CIVILIZATION_KONGO', 'LEADER_MVEMBA', { leaderDisplayName: 'Mvemba a Nzinga' }),
    new CivDef('CIVILIZATION_BRAZIL', 'LEADER_PEDRO', { leaderDisplayName: 'Pedro II' }),
    new CivDef('CIVILIZATION_GREECE', 'LEADER_PERICLES'),
    new CivDef('CIVILIZATION_RUSSIA', 'LEADER_PETER_GREAT', { leaderDisplayName: 'Peter the Great' }),
    new CivDef('CIVILIZATION_SPAIN', 'LEADER_PHILIP_II', { leaderDisplayName: 'Philip II' }),
    new CivDef('CIVILIZATION_CREE', 'LEADER_POUNDMAKER', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
    new CivDef('CIVILIZATION_CHINA', 'LEADER_QIN', { leaderDisplayName: 'Qin Shi Huang' }),
    new CivDef('CIVILIZATION_SCOTLAND', 'LEADER_ROBERT_THE_BRUCE', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
    new CivDef('CIVILIZATION_ARABIA', 'LEADER_SALADIN'),
    new CivDef('CIVILIZATION_KOREA', 'LEADER_SEONDEOK', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
    new CivDef('CIVILIZATION_ZULU', 'LEADER_SHAKA', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
    new CivDef('CIVILIZATION_GEORGIA', 'LEADER_TAMAR', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
    new CivDef('CIVILIZATION_AMERICA', 'LEADER_T_ROOSEVELT', { leaderDisplayName: 'Teddy Roosevelt' }),
    new CivDef('CIVILIZATION_SCYTHIA', 'LEADER_TOMYRIS'),
    new CivDef('CIVILIZATION_ROME', 'LEADER_TRAJAN'),
    new CivDef('CIVILIZATION_NETHERLANDS', 'LEADER_WILHELMINA', { dlcId: '1B28771A-C749-434B-9053-D1380C553DE9' }),
