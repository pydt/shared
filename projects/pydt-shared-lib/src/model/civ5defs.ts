...
class Civ5Def extends CivDef {
    getImageFileName() {
        ...
        return `${CIV5_GAME.assetPrefix}${this.civKey.replace('CIVILIZATION_', '')}_${this.leaderKey.replace('LEADER_', '')}.png`;
    }
}
...
export const CIV5_LEADERS = [
    ...
    new Civ5Def('CIVILIZATION_ASSYRIA', 'LEADER_ASHURBANIPAL', {
        dlcId: '3676a06d23411840b6436575b4ec336b'
    }),
    new Civ5Def('CIVILIZATION_AUSTRIA', 'LEADER_MARIA', {
        leaderDisplayName: 'Maria Theresa',
        dlcId: 'a151370e40f81b4e9706519bf484e59d'
    }),
    new Civ5Def('CIVILIZATION_AZTEC', 'LEADER_MONTEZUMA'),
    new Civ5Def('CIVILIZATION_BABYLON', 'LEADER_NEBUCHADNEZZAR', {
        leaderDisplayName: 'Nebuchadnezzar II',
        dlcId: '32ba59746457ae448e9501ad0e0efd48'
    }),
    new Civ5Def('CIVILIZATION_BRAZIL', 'LEADER_PEDRO', {
        leaderDisplayName: 'Pedro II',
        dlcId: '3676a06d23411840b6436575b4ec336b'
    }),
    new Civ5Def('CIVILIZATION_BYZANTIUM', 'LEADER_THEODORA', {
        dlcId: 'a151370e40f81b4e9706519bf484e59d'
    }),
    new Civ5Def('CIVILIZATION_CARTHAGE', 'LEADER_DIDO', {
        dlcId: 'a151370e40f81b4e9706519bf484e59d'
    }),
    new Civ5Def('CIVILIZATION_CELTS', 'LEADER_BOUDICCA', {
        dlcId: 'a151370e40f81b4e9706519bf484e59d'
    }),
    new Civ5Def('CIVILIZATION_CHINA', 'LEADER_WU_ZETIAN'),
    new Civ5Def('CIVILIZATION_DENMARK', 'LEADER_HARALD', {
    ...
    new Civ5Def('CIVILIZATION_ETHIOPIA', 'LEADER_SELASSIE', {
    ...
    new Civ5Def('CIVILIZATION_HUNS', 'LEADER_ATTILA', {
        dlcId: 'a151370e40f81b4e9706519bf484e59d'
    }),
    new Civ5Def('CIVILIZATION_INCA', 'LEADER_PACHACUTI', {
        dlcId: 'ded585b6ca7c754e81b42f60754e6330'
    }),
    new Civ5Def('CIVILIZATION_INDIA', 'LEADER_GANDHI'),
    new Civ5Def('CIVILIZATION_INDONESIA', 'LEADER_GAJAH_MADA', {
        dlcId: '3676a06d23411840b6436575b4ec336b'
    }),
    new Civ5Def('CIVILIZATION_IROQUOIS', 'LEADER_HIAWATHA'),
    new Civ5Def('CIVILIZATION_JAPAN', 'LEADER_ODA_NOBUNAGA'),
    new Civ5Def('CIVILIZATION_KOREA', 'LEADER_SEJONG', {
        dlcId: 'b2222c110853b642b734171ccab3037b'
    }),
    new Civ5Def('CIVILIZATION_MAYA', 'LEADER_PACAL', {
        dlcId: 'a151370e40f81b4e9706519bf484e59d'
    }),
    new Civ5Def('CIVILIZATION_MONGOL', 'LEADER_GENGHIS_KHAN', {
        dlcId: 'e31e3c297611f644ac1f59663826de74'
    }),
    new Civ5Def('CIVILIZATION_MOROCCO', 'LEADER_AHMAD_ALMANSUR', {
        leaderDisplayName: 'Ahmad al-Mansur',
        dlcId: '3676a06d23411840b6436575b4ec336b'
    }),
    new Civ5Def('CIVILIZATION_NETHERLANDS', 'LEADER_WILLIAM', {
        dlcId: 'a151370e40f81b4e9706519bf484e59d'
    }),
    ...
    new Civ5Def('CIVILIZATION_POLAND', 'LEADER_CASIMIR', {
        leaderDisplayName: 'Casimir III',
        dlcId: '3676a06d23411840b6436575b4ec336b'
    }),
    new Civ5Def('CIVILIZATION_POLYNESIA', 'LEADER_KAMEHAMEHA', {
        dlcId: '05c6f7ec11baac4c8d80d71306aac471'
    }),
    new Civ5Def('CIVILIZATION_PORTUGAL', 'LEADER_MARIA_I', {
        dlcId: '3676a06d23411840b6436575b4ec336b'
    }),
    ...
    new Civ5Def('CIVILIZATION_SHOSHONE', 'LEADER_POCATELLO', {
        dlcId: '3676a06d23411840b6436575b4ec336b'
    }),
    new Civ5Def('CIVILIZATION_SIAM', 'LEADER_RAMKHAMHAENG'),
    new Civ5Def('CIVILIZATION_SPAIN', 'LEADER_ISABELLA', {
        dlcId: 'ded585b6ca7c754e81b42f60754e6330'
    }),
    new Civ5Def('CIVILIZATION_SONGHAI', 'LEADER_ASKIA'),
    new Civ5Def('CIVILIZATION_SWEDEN', 'LEADER_GUSTAVUS_ADOLPHUS', {
        dlcId: 'a151370e40f81b4e9706519bf484e59d'
    }),
    new Civ5Def('CIVILIZATION_VENICE', 'LEADER_ENRICO_DANDOLO', {
        dlcId: '3676a06d23411840b6436575b4ec336b'
    }),
    new Civ5Def('CIVILIZATION_ZULU', 'LEADER_SHAKA', {
        dlcId: '3676a06d23411840b6436575b4ec336b'
    })
];
